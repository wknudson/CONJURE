...
export interface MarkDef {
   ...
   *
   * A Mark used to be a pure trap: it cost a Bone, attached, and then did nothing whatsoever
   ...
   * makes the *next* swing worth the Bone it costs, which is the job the card layer is supposed
