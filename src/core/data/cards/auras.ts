...
export const AURA_CARDS: Record<string, CardDef> = {
  ...
  ember_coat: {
    ...
    source: 'hero',
    kind: 'spell',
    text: 'Wraps an ally in fire. +10 ATK per stack, to two. At Climax it burns what it strikes.',
    target: ALLY_UNIT,
  ...
  verdant_swell: {
    ...
    source: 'hero',
    kind: 'spell',
    text: 'Roots an ally deeper. +20 Max HP per stack, to two. At Climax it drinks what it wounds.',
    target: ALLY_UNIT,
  ...
  petrifying_mantle: {
    ...
    source: 'hero',
    kind: 'spell',
    text: 'Sets an ally in stone. +10 Persistent Armor per stack, to two. At Climax nothing shoves it.',
    target: ALLY_UNIT,
  ...
  marrow_siphon: {
    ...
    source: 'hero',
    kind: 'spell',
    text: 'Opens an ally to the dark. Each turn it bleeds 10 and yields 1 Marrow. It does not stop.',
    target: ALLY_UNIT,
