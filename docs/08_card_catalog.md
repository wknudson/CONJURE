...
**122 base cards.** Rank 2 printings are derived, not authored — see [Rank 2](#rank-2).

| Kind | Count | Whose | Where it goes |
|---|---:|---|---|
| minion | 50 | Hero | Vanguard Roster, never a deck |
| spell | 44 | Companion | drafted into a Grimoire |
| ability | 10 | Hero | Hero Deck |
| mark | 6 | Hero | Hero Deck |
| obstacle | 12 | Hero | Hero Deck, shown as a Construct |
| **total** | **122** | | |
...
| [`pyre.ts`](#pyrets) | 3 | 1 minion, 1 spell, 1 obstacle |
| [`frost.ts`](#frostts) | 10 | 2 minion, 6 spell, 2 obstacle |
| [`companionUnits.ts`](#companionunitsts) | 20 | 20 minion |
| [`terrain.ts`](#terraints) | 5 | 5 obstacle |
| [`ranged.ts`](#rangedts) | 3 | 3 minion |
| [`surge.ts`](#surgets) | 7 | 3 minion, 4 spell |
| [`bloom.ts`](#bloomts) | 5 | 2 minion, 3 spell |
| [`bulwark.ts`](#bulwarkts) | 6 | 3 minion, 3 spell |
| [`dusk.ts`](#duskts) | 8 | 4 minion, 3 spell, 1 obstacle |
| [`gaslamp.ts`](#gaslampts) | 4 | 1 minion, 2 spell, 1 ability |
| [`wildlife.ts`](#wildlifets) | 2 | 2 minion |
| [`threats.ts`](#threatsts) | 3 | 3 minion |
| [`hybrid.ts`](#hybridts) | 11 | 11 spell |
...
Pyre expansion — burst and burn. — **3 cards** (1 minion, 1 spell, 1 obstacle).
...
Frost expansion — slow, freeze, shatter. — **10 cards** (2 minion, 6 spell, 2 obstacle).
...
| **Lexis** | `lexis_bound` | minion | 0 | 1 | companion | 10 atk, 40 hp, 3 mov, rng 1-2, caster | — | none | BoundForm | setup only | Bound Form. Your Arcane cards are cast from where it stands. Wounds it takes are dealt to your Pact. |
...
Surge expansion — charge and chain. — **7 cards** (3 minion, 4 spell).
...
Bloom expansion — growth and regrowth. — **5 cards** (2 minion, 3 spell).
...
Bulwark expansion — plate and hold. — **6 cards** (3 minion, 3 spell).
...
Dusk expansion — drain, decay, the graveyard. — **8 cards** (4 minion, 3 spell, 1 obstacle).
...
Splice products. Obtainable only at the bench. — **11 cards** (11 spell).
